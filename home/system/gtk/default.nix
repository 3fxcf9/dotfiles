{
  ...
  home.file = {
    ...
    ".local/share/themes/FlatColor/colors2".text = ''
      ...
      tooltip_bg_color:#${config.var.theme.colors.bg}
      tooltip_fg_color:#${config.var.theme.colors.fg}
      titlebar_bg_color:#${config.var.theme.colors.bg}
      titlebar_fg_color:#${config.var.theme.colors.fg}
      menu_bg_color:#${config.var.theme.colors.bg}
      menu_fg_color:#${config.var.theme.colors.fg}
    ...
    ".local/share/themes/FlatColor/colors3".text = ''
      ...
      @define-color tooltip_bg_color #${config.var.theme.colors.bg};
      @define-color tooltip_fg_color #${config.var.theme.colors.fg};
    '';
  };
}
